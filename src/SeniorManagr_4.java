...
import java.awt.*;
	...
	public class  SeniorManagr_4 extends JFrame implements ActionListener
	 { 
		JMenuBar menubar;
		...
		public SeniorManagr_4(String title)
	  	{
			super("ELECTRICITY ..BILLING.. SYSTEM: ADMINISTRATOR");
...
*/
	 //--------------------------------------------------------------------------------			
			...
			public static void main(String arg[])
			{
				...
				ss3.setSize(1000,720);
								ss3.setBackground(Color.white);
								ss3.setVisible(true);
								}

//package updated1;
	...
	public class  SeniorManagr extends JFrame implements ActionListener
	 { 
		JMenuBar menubar;
		...
		public SeniorManagr(String title)
	  	{
			super("ELECTRICITY ..BILLING.. SYSTEM: SENIOR MANAGER");
...
*/
	 //--------------------------------------------------------------------------------			
			...
			public static void main(String arg[])
			{
				...
				ss0.setSize(1000,720);
								ss0.setBackground(Color.white);
								ss0.setVisible(true);
								}
